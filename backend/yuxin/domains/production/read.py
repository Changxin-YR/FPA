...
from yuxin.kernel.workflow import RowAction, Workflow
...
def _md():
    ...
    """
    from yuxin.domains.master_data.service import lookup_materials, lookup_ponds
...
class BatchService(_ProductionReadService):
    ...
    def _enrich(self, tx: UnitOfWork, rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
        from yuxin.domains.master_data.service import lookup_areas, lookup_ponds
