...
from yuxin.kernel.fields import f_date, f_datetime, f_int, f_num, f_ref, f_str, text
...
class WarehouseDocumentService(WarehouseQueryService):
    ...
    def load_warehouse_document(
        ...
        `__yuxin_load_by_id__`**，否则 `_reload_after` 抛 `INTERNAL_ERROR`
...
for _method in (
    ...
    _method.__yuxin_load_by_id__ = WarehouseDocumentService.load_warehouse_document  # type: ignore[attr-defined]
