...
from fpa.kernel.fields import Choice, f_enum, f_int, f_num, f_str, text
...
# `kernel/runner.py` 三处按 `getattr(handler, "__fpa_load_by_id__")` 解析，
