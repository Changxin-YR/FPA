...
from fpa.kernel.audit import AuditEvent, AuditWriter
...
from fpa.kernel.errors import DomainError, ErrorCode, forbidden
...
class AgentToolGateway:
    ...
    def tools_payload(self, permissions: frozenset[str]) -> dict[str, Any]:
        ...
        `FPA_AGENT_TOOL_CATALOG`，源码注释自承是为了绕开 Windows 进程环境变量上限。
        """
